...
class RentablesControllerTest < ActionController::TestCase
  ...
  test "should create rentable" do
    assert_difference('Rentable.count') do
      post :create, rentable: { category: @rentable.category, location: @rentable.location, name: @rentable.name, quantity: @rentable.quantity }
    end
  ...
  test "should update rentable" do
    patch :update, id: @rentable, rentable: { category: @rentable.category, location: @rentable.location, name: @rentable.name, quantity: @rentable.quantity }
    assert_redirected_to rentable_path(assigns(:rentable))
  end
